...
export default function DialogAddHighlight(props) {
	...
	const handleSubmit = e => {
		...
		highlightService.addHighlight(values)
			.then(res => {
				handleClose();
				props.updateParent();
				resetForm();
    ...
    return (
        <>
            ...
            <br/>
			<Box component="div" display="inline" className={classes.text}>New Highlight</Box>
        </>
    );
}
