...
export default function DailyTasks() {
    ...
    useEffect(() => {
        ...
        let lastDate = new Date(currentDate.getFullYear(), currentDate.getMonth(), currentDate.getDate());
        ...
        const apiPath = `http://localhost:3300/api/tasks/${startDateTimestamp}/${endDateTimestamp}`;
                    ...
                    <Grid>
                        ...
                        {dates.map((date, key) => {
                            ...
                            if (activity.Date.getTime() === date.getTime()) {
                                ...
                                return <TaskBox status={activity.Status} taskDate={activity.Date} />
                            } else {
